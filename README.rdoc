= Powerpoint --  for Powerpoint(pptx) files.

powerpoint is a Ruby gem that can generate Powerpont(pptx) slides.
...
== Basic Usage
Powerpoint can generate a powerpoint presentaion based on a standard template:

    require 'powerpoint'
    
    @deck = Powerpoint::Presentation.new 'test.pptx'
