...
module Powerpoint
  module Slide
    class Dashboard
      ...
      attr_reader :title, :subtitle, :subtitle_2, :image_path, :image_path_2,:image_path_3,:image_path_4, :image_name, :data

      def initialize(options={})
        require_arguments [:title, :subtitle, :image_path, :image_path_2,:image_path_3, :image_path_4, :subtitle_2, :data], options
