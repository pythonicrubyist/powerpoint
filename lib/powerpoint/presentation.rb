...
module Powerpoint
  class Presentation
    ...
    def add_dashboard_slide(title, subtitle = nil, page_number, graph_1_title, graph_1_subtitle, graph_2_title, graph_2_subtitle, image_1, image_2, image_3, image_4, logo, data)
    ...
    def add_dashboard_user_slide(title, subtitle = nil, pge_number, logo, images)
